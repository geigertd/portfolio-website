    ...
    <section id="contact" className="bg-white dark:bg-slate-900 py-24 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-6">
          ...
          {/* Email */}
          <a
            href="mailto:geigertd@placeholder.com"
            aria-label="Email"
            className="flex items-center gap-2.5 px-5 py-3 rounded-lg border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:border-indigo-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors text-sm font-medium"
          >
